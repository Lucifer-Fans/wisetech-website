...
export default function TeamDashboard() {
  ...
  const load = async () => {
    const res = await api.get("/team/admin/list", {
      params: {
        page: currentPage,
        limit: itemsPerPage,
        search: searchQuery,
  ...
  useEffect(() => {
    const updateItemsPerPage = () => {
      ...
      if (width < 768) setItemsPerPage(15);
  ...
  return (
    <div className="w-full">
      <h1 className="text-[30px] font-bold mb-4">Team Fun Dashboard</h1>
            ...
            {teams.map((t) => (
              ...
              >
                ...
                <td className="px-4 py-2">
                  <span className="px-4 py-2 text-black font-[16px] capitalize">
                    {t.category}
                  </span>
                </td>
